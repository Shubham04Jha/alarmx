...
import 'package:alarmx/app/utils/languages/french_translations.dart';
import 'package:alarmx/app/utils/languages/german_translations.dart';
import 'package:alarmx/app/utils/languages/russian_translations.dart';
import 'package:alarmx/app/utils/languages/spanish_translations.dart';
...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'This project was originally developed as part of Google Summer of code under the shubham organization. It\'s free, the source code is available, and we encourage programmers to contribute':
              'This project was originally developed as part of Google Summer of code under the shubham organization. It\'s free, the source code is available, and we encourage programmers to contribute',
