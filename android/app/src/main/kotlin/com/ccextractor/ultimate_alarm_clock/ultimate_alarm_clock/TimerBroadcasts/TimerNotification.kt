...
import com.shubham.alarmx.getLatestTimer
...
class TimerNotification : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "com.shubham.alarmx.START_TIMERNOTIF" || intent.action == Intent.ACTION_BOOT_COMPLETED) {
        ...
        if (intent.action == "com.shubham.alarmx.STOP_TIMERNOTIF") {
    ...
    private fun showTimerNotification(milliseconds: Long, timerName: String, context: Context) {
        ...
        deleteIntent.action = "com.shubham.alarmx.STOP_TIMERNOTIF"
