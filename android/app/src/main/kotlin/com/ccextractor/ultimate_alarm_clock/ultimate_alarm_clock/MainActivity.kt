...
class MainActivity : FlutterActivity() {
    companion object {
        ...
        const val ACTION_START_FLUTTER_APP = "com.shubham.alarmx"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intentFilter.addAction("com.shubham.alarmx.START_TIMERNOTIF")
        intentFilter.addAction("com.shubham.alarmx.STOP_TIMERNOTIF")
        ...
        methodChannel2.setMethodCallHandler { call, result ->
            if (call.method == "playDefaultAlarm") {
                ...
                val startTimerIntent =
                    Intent("com.shubham.alarmx.START_TIMERNOTIF")
                context.sendBroadcast(startTimerIntent)

            } else if (call.method == "clearTimerNotif") {
                val stopTimerIntent = Intent("com.shubham.alarmx.STOP_TIMERNOTIF")
